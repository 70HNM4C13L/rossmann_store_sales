...
class Rossmann(object):
    ...
    def data_cleaning(self, df1):
        ...
        df1['is_promo'] = df1[['month_map', 'promo_interval']].apply(
    ...
    def data_preparation(self, df5):
        ...
        df5['competition_since_month'] = self.competition_since_month_scaler.transform(
    ...
    def get_predction(self, model, original_data, test_data) :
        ...
        pred = model.predict ( test_data )
         ...
         #join predcti in to the original data
